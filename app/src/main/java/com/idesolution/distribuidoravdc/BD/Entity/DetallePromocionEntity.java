...
@Entity(tableName = Constante.NAME_TABLE_DETALLE_PROMOCION)
public class DetallePromocionEntity {
    ...
    public DetallePromocionEntity(int ntra, @NonNull String ntraPromocion, int flag, String descripcion, int valorEntero1, int valorEntero2, double valorMoneda1, double valorMoneda2, String valorCadena1, String valorCadena2, String valorFecha1, String valorFecha2, short estado) {
        this.ntra = ntra;
