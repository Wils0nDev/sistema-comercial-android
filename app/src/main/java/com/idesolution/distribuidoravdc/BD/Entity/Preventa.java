...
public class Preventa {
    ...
    private Integer ntraPreventa;       //codigo de preventa
    ...
    private short flag;                 //flag 1 - servidor , 0 -  registro , 2 - modificar , 3 - anular
...
/*
    @Ignore
    public Preventa(Integer ntraPreventa, Integer codCliente, short tipoDocumento, String numeroDocumento, Integer codUsuario, Integer codPuntoEntrega, short moneda, short tipoVenta, short tipoDocumentoVenta, String fecha, short flagRecargo, double recargo, double igv, double isc, double total, short estado, short flag) {
    ...
    */
    ...
    public Preventa(Integer ntraPreventa, Integer codCliente, short tipoDocumento, String numeroDocumento, Integer codUsuario, Integer codPuntoEntrega, short moneda, short tipoVenta, short tipoDocumentoVenta, String fecha, short flagRecargo, double recargo, double igv, double isc, double total, short estado, short flag, short origenVenta, String fechaEntrega, String horaEntrega, Integer codSucursal) {
        this.ntraPreventa = ntraPreventa;
        this.codCliente = codCliente;
        this.tipoDocumento = tipoDocumento;
        this.numeroDocumento = numeroDocumento;
