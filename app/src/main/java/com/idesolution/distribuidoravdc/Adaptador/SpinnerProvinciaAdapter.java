...
public class SpinnerProvinciaAdapter extends ArrayAdapter<ProvinciaEntity> {
    public SpinnerProvinciaAdapter(Context context, List<ProvinciaEntity> countryList) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        ProvinciaEntity currentItem = getItem(position);
