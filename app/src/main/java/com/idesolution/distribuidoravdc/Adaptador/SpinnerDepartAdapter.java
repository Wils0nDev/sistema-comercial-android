...
public class SpinnerDepartAdapter extends ArrayAdapter<DepartamentoEntity> {
    public SpinnerDepartAdapter(Context context, List<DepartamentoEntity> countryList) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        DepartamentoEntity currentItem = getItem(position);
